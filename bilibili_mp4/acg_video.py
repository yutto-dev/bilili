...
from bilibili_mp4.downloader import BililiContainer, Status
...
parse_api = "https://api.bilibili.com/x/player/playurl?avid={avid}&cid={cid}&bvid={bvid}&qn={qn}&type=&otype=json&platform=html5&high_quality=1"
