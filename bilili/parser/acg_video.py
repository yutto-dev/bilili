import os
from bilili.api.acg_video import (get_acg_video_title, get_acg_video_list,
...
def get_subtitle(container):
    return get_acg_video_subtitle(avid=container.meta['avid'], bvid=container.meta['bvid'], cid=container.meta['cid'])
