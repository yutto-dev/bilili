        ...
        while True:
            ...
            console.refresh(
                [
                    ...
                    {"left": "Merging videos: "} if global_status.merging else None,
                    [
                        {"left": f"{str(container)} ", "right": True} if container._.merging else None
                        for container in containers
                    ]
                    if global_status.merging
                    else None,
                    {
