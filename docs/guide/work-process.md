...
最开始，我会解析你的 url 类型，依此送入 [bangumi API 解析器](https://github.com/yutto-dev/bilili/blob/main/src/bilili/parser/bangumi.py)或者 [acg_video API 解析器](https://github.com/yutto-dev/bilili/blob/main/bilili/src/parser/acg_video.py)
